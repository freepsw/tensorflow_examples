...
# 모델의 각 단계별 W(weight)에 랜덤하게 값을 설정하기 위한 함수
...
#    softmax_cross_entropy_with_logits 함수 : activation 값이 softmax를 통하지 않은 숫자를 사용하는 함수
...
with tf.Session() as sess:
    ...
    print "model check path : %s " % ckpt.model_checkpoint_path
